...
\title{Comparative study of neural models for the StanceCat shared task at IberEval 2017}
\date{}
...
\input{docs/task}			% Task description
\input{docs/system}		% Methods description
\input{docs/evaluation}		% Methods evaluations
\input{docs/conclusions}	% Conclusions
...
\input{refs/references_llncs}	% Conclusions
