...
First we illustrate the metric proposed by organizers for system's evaluation (\Cref{subsec:metric}), then we outline empirical results produced by a 10-fold cross validation over the given data set (\Cref{subsec:study}), finally we report our performance at the shared task (\Cref{subsec:results}).
