...
from arf_runners.gender_runner_ca import run as run_gender_ca
...
for cleaning_function in pre_processing_functions:
    ...
    for i in range(K_folds):
        results = run_gender_ca(cleaning_function)
    ...
    with open("../gender_ca.csv", 'a') as outcsv:
        ...
        writer.writerow(["model_name", "cleaning_function", "mean_accuracy", "std_accuracy"])
