...
stance_model = CnnLstmModel(data_function=stance.load_stance_es, decode_function=stance.decode_stance,
...
gender_model = CnnLstmModel(data_function=stance.load_gender_es, decode_function=stance.decode_gender,
                            persist_function=None, test_function=stance.load_test_es)
...
with open("stancecat17.atoppe.3.es", 'w') as out_file:
