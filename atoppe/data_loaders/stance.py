...
abs_truth_path = os.path.join(script_dir, '../../resources/stance/training_truth_ca.txt')
abs_tweets_path = os.path.join(script_dir, '../../resources/stance/training_tweets_ca.txt')
